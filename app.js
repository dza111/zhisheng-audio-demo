...
const people = {
  recording: [
    { id:'dong-zheao', name:'董喆奥', role:'录音工程师', styles:['流行','说唱','人声录音','乐器录音','影视配音'], price:'按需求沟通', image:'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?auto=format&fit=crop&w=900&q=80', exp:'5 年录音经验', works:'录制 1000+ 首音乐、300+ 配乐作品', intro:'深耕人声录音、乐器录音与影视配音领域，为每位客户提供专业录音指导。', skills:['人声录音','乐器录音','影视配音','录音插件与麦克风摆位','话放调节'], prices:[['服务价格','按需求沟通']] },
    { id:'cheng-honglin', name:'程鸿林', role:'录音工程师', styles:['流行','说唱','人声录音','乐器录音'], price:'按需求沟通', image:'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=900&q=80', exp:'6 年录音经验', works:'录制 600+ 首音乐作品', intro:'专注人声与乐器录音，为每位客户提供专业录音指导，熟练完成麦克风摆位与话放调节。', skills:['人声录音','乐器录音','录音插件','麦克风摆位','话放调节'], prices:[['服务价格','按需求沟通']] }
  ],
  mixing: [
    { id:'dong-zheao', name:'董喆奥', role:'混音工程师', styles:['说唱混音','流行混音','古典混音','母带处理'], price:'按需求沟通', image:'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=900&q=80', exp:'5 年混音经验', works:'完成混音 + 母带 1000+ 首作品', intro:'深耕贴唱混音与分轨混音，擅长说唱、流行、电子、古典等风格，熟练处理 EQ、压缩与母带工程。', skills:['说唱混音','流行混音','古典混音','母带处理','EQ 与压缩'], prices:[['服务价格','按需求沟通']] },
    { id:'cheng-honglin', name:'程鸿林', role:'混音工程师', styles:['流行混音','说唱混音','民谣混音','母带处理'], price:'按需求沟通', image:'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=900&q=80', exp:'多年音频混音经验', works:'完成混音 + 母带 600+ 首作品', intro:'专注流行、说唱、民谣类歌曲混音，擅长人声精修、声场搭建与动态处理，提供母带适配的一站式制作。', skills:['流行混音','说唱混音','民谣混音','人声精修','声场与动态处理'], prices:[['服务价格','按需求沟通']] }
  ],
  arrangement: [
    { id:'pm', name:'P.M', role:'编曲制作人', styles:['流行编曲','嘻哈编曲','音色设计','编排统筹'], price:'888 元起', image:'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=900&q=80', exp:'熟练使用 FL Studio，阅曲 20,000+', works:'制作超过 200 首伴奏', intro:'深耕地下与主流嘻哈伴奏制作，擅长 Boombap、硬核、Chicago Drill、Memphis、Glo 等风格，对采样嘻哈有独特审美。', skills:['流行编曲','嘻哈编曲','音色设计','编排统筹','母带制作'], prices:[['基础编曲','888 元'],['高级制作','2,000 元']] },
    { id:'tai-laoshi', name:'太老师', role:'编曲制作人', styles:['流行编曲','影视配乐','古典编曲','乐器教学'], price:'按需求沟通', image:'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=900&q=80', exp:'流行、古典与配乐创作 10 余年', works:'制作 2000+ 编曲、300+ 影视配乐', intro:'深耕流行乐曲、古典乐曲与影视配乐，兼具钢琴、吉他演奏及舞台演出经验。', skills:['流行编曲','影视配乐','古典编曲','舞台演出','乐器教学'], prices:[['服务价格','按需求沟通']] }
  ],
  live: [
    { id:'dong-zheao', name:'董喆奥', role:'直播音频工程师', styles:['直播人声精调','降噪处理','声场搭建','母带优化'], price:'按需求沟通', image:'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?auto=format&fit=crop&w=900&q=80', exp:'5 年直播音效调试经验', works:'完成直播音频调试、音效优化 500+ 场次', intro:'擅长直播人声调校、设备适配与声场优化，熟练解决降噪、均衡、压缩等直播音频问题。', skills:['直播人声精调','直播降噪处理','直播声场搭建','直播音频母带优化'], prices:[['服务价格','按需求沟通']] },
    { id:'cheng-honglin', name:'程鸿林', role:'直播音频工程师', styles:['直播人声调校','降噪优化','声场搭建','设备适配'], price:'按需求沟通', image:'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=900&q=80', exp:'多年直播音频调试经验', works:'完成直播音频调试、音效优化 300+ 场次', intro:'专注直播人声调试与直播音频优化，精细化调试直播设备，提供一站式直播音频适配方案。', skills:['直播人声调校','直播降噪优化','直播声场搭建','直播音频母带适配'], prices:[['服务价格','按需求沟通']] }
  ]
};

const verifiedPersonImages = {
  'recording:dong-zheao':'/assets/people/dong-zheao.jpeg',
  'recording:cheng-honglin':'/assets/people/cheng-honglin.jpeg',
  'mixing:dong-zheao':'/assets/people/dong-zheao.jpeg',
  'mixing:cheng-honglin':'/assets/people/cheng-honglin.jpeg',
  'arrangement:pm':'/assets/people/pm.jpeg',
  'arrangement:tai-laoshi':'/assets/people/tai-laoshi.jpeg',
  'live:dong-zheao':'/assets/people/dong-zheao.jpeg',
  'live:cheng-honglin':'/assets/people/cheng-honglin.jpeg'
};
Object.entries(people).forEach(([kind, entries]) => entries.forEach(person => {
  person.image = verifiedPersonImages[`${kind}:${person.id}`] || person.image;
}));
...
function header(){ const path=location.pathname; const active = route => path === route || path.startsWith(`${route}/`); return `<header class="shell topbar"><a class="brand" href="/" data-route><span class="brand-mark">${icon('audio-lines')}</span><span>智声科技</span></a><nav class="nav" aria-label="主要导航"><a class="${path==='/'?'active':''}" href="/" data-route>首页</a><a class="${active('/recording')?'active':''}" href="/recording" data-route>录音</a><a class="${active('/mixing')?'active':''}" href="/mixing" data-route>混音</a><a class="${active('/arrangement')?'active':''}" href="/arrangement" data-route>编曲</a><div class="nav-dropdown ${active('/teaching')?'active':''}"><a href="/teaching" data-route>教学 ${icon('chevron-down')}</a><div class="nav-dropdown-menu"><a href="/teaching/recording" data-route>录音课程</a><a href="/teaching/mixing" data-route>混音课程</a><a href="/teaching/arrangement" data-route>编曲课程</a></div></div><a class="${active('/live')?'active':''}" href="/live" data-route>直播调试</a><a class="${active('/presets')?'active':''}" href="/presets" data-route>效果预设</a><a class="${active('/equipment')?'active':''}" href="/equipment" data-route>设备供应</a><a class="nav-ai ${active('/ai-agent')?'active':''}" href="/ai-agent" data-route>${icon('sparkles')} AI 智能体</a><a data-mixing-nav class="nav-mixing ${active('/ai-mixing')?'active':''}" href="/ai-mixing" data-route>${icon('sliders-horizontal')} AI 混音</a></nav><button class="icon-button" title="通知">${icon('bell')}</button></header>`; }
...
function personGenres(person){ const styles=person.styles.join(' '); const genres=[]; if(/流行|R&B|广告/.test(styles))genres.push('流行'); if(/说唱|嘻哈|Hip-Hop|Rap|Trap/.test(styles))genres.push('说唱'); if(/古典|民谣|国风|影视|配乐|乐队/.test(styles))genres.push('古典'); if(/影视|配乐/.test(styles))genres.push('影视配乐'); return genres.join(' '); }
function personCard(person, kind){ return `<article class="person-card" data-genres="${personGenres(person)}"><div class="person-cover"><img src="${person.image}" alt="${person.name}"/><span class="role-tag">${person.role}</span></div><div class="person-body"><div class="person-name"><h3>${person.name}</h3><span class="verified" title="已认证">${icon('badge-check')}</span></div><p class="person-role">${person.exp}</p>${tags(person.styles)}<div class="price-row"><div><small>${kind==='live'?'基础调试':'服务起价'}</small><strong>${person.price}</strong></div>${link(`/${kind}/${person.id}`,`查看详情 ${icon('arrow-up-right')}`,'text-link')}</div></div></article>`; }
...
function listing(kind, title, description){ const filters=kind==='arrangement'?['全部','流行','说唱','古典','影视配乐']:['全部','流行','说唱','古典']; return `<main class="shell page"><section class="page-title"><div class="eyebrow">${kind.toUpperCase()} / CURATED</div><h1>${title}</h1><p>${description}</p></section><div class="filter-bar">${filters.map((filter,index)=>`<button class="filter${index===0?' active':''}" data-filter="${filter}">${filter}</button>`).join('')}</div><section class="people-grid">${people[kind].map(p=>personCard(p,kind)).join('')}</section></main>`; }
function detail(kind,id){ const person=people[kind]?.find(p=>p.id===id); if(!person) return notFound(); const roleNames={recording:'录音服务',mixing:'混音服务',arrangement:'编曲服务',live:'直播调试'}; const works=kind==='mixing'?['霓虹夜行','没有你的周末','Be Right Back']:['Demo Session 01','Live Room Take','Untitled, V3']; return `<main class="shell"><section class="detail-hero"><div class="detail-photo"><img src="${person.image}" alt="${person.name}"/></div><div class="detail-intro"><div class="eyebrow">${roleNames[kind]} / VERIFIED</div><h1>${person.name}</h1><div class="tags">${tags(person.styles)}</div><p>${person.intro}</p><div class="detail-stats"><div class="detail-stat"><span>专业经验</span><strong>${person.exp}</strong></div><div class="detail-stat"><span>项目履历</span><strong>${person.works}</strong></div><div class="detail-stat"><span>响应状态</span><strong>可预约</strong></div></div>${link('/ai-agent',`让 AI 协助匹配 ${icon('sparkles')}`,'btn btn-primary')}</div></section><section class="detail-grid"><div><div class="detail-section"><h2>个人介绍</h2><p>${person.intro} 以清晰的沟通和可执行的制作建议，帮助创作者让声音更接近心中的想象。</p></div><div class="detail-section"><h2>${kind==='mixing'?'技术能力':'专业能力'}</h2><div class="skill-list">${person.skills.map(x=>`<div class="skill-item">${x}</div>`).join('')}</div></div><div class="detail-section"><h2>作品试听</h2>${portfolioTracks(kind,id)}</div></div><aside class="pricing"><div class="pricing-head"><h3>服务价格</h3></div>${person.prices.map(p=>`<div class="price-item"><span>${p[0]}</span><strong>${p[1]}</strong></div>`).join('')}<button class="btn btn-primary" data-contact>咨询档期 ${icon('message-circle')}</button></aside></section></main>`; }
function equipmentPage(){ return `<main class="shell page"><section class="page-title"><div class="eyebrow">EQUIPMENT / CURATED</div><h1>设备供应与选型</h1><p>从直播入门到家庭工作室，按预算与实际使用场景提供更合适的设备组合。</p></section>${equipmentCatalogue()}<section class="consult"><div class="consult-head"><div><div class="eyebrow">AI EQUIPMENT GUIDE</div><h2>告诉我你的使用场景</h2><p>例如：我是新手主播，预算 3000 元，需要一套直播设备。</p></div><span class="service-icon">${icon('headphones')}</span></div><div class="consult-form"><input id="consultInput" aria-label="设备需求" placeholder="输入预算、用途或已有设备"/><button class="btn btn-primary" id="consultButton">获取建议 ${icon('arrow-up-right')}</button></div><div id="consultResult" class="consult-result"></div></section></main>`; }
function presetsPage(){ const presets=[['人声清晰预设','让播客、直播和配音的人声更靠前、更稳定。','mic-vocal','直播人声 / 配音'],['流行人声预设','保留人声细节，建立明亮、有空气感的流行表达。','sparkles','流行 / 抒情'],['说唱人声预设','强化咬字、动态与低频控制，适配 Hip-Hop 制作。','audio-waveform','Rap / Hip-Hop'],['空间氛围预设','为和声、主唱和器乐增添可控的空间层次。','waves','民谣 / 氛围'],['母带试听预设','用于发布前试听检查，统一成品响度与听感。','sliders-horizontal','成品试听'],['直播唱歌预设','针对声卡、麦克风与演唱习惯快速建立起始方案。','radio','唱歌直播']]; return `<main class="shell page"><section class="page-title"><div class="eyebrow">EFFECT PRESETS / STARTING POINTS</div><h1>效果预设</h1><p>由智声科技整理的专业音频起始方案。预设用于快速建立声音方向，后续仍可按歌手、设备和场景做精细调整。</p></section><section class="preset-grid">${presets.map(([name,description,ico,tag])=>`<article class="preset-card"><span class="service-icon">${icon(ico)}</span><span class="preset-tag">${tag}</span><h3>${name}</h3><p>${description}</p><button class="text-link" data-contact>让 AI 推荐方案 ${icon('arrow-up-right')}</button></article>`).join('')}</section><section class="feature-band"><div><div class="eyebrow">AI PRESET GUIDE</div><h2>不知道从哪个预设开始？</h2><p>描述你的曲风、参考作品、设备和想要的声音感受，AI 智能体会帮你推荐合适的起点。</p></div>${link('/ai-agent',`咨询 AI 智能体 ${icon('sparkles')}`,'btn btn-primary')}</section></main>`; }
const presetLibrary=[
  {id:'rap',name:'智声说唱预设',description:'强化咬字、动态与低频控制，适配 Hip-Hop 制作。',icon:'audio-waveform',tag:'RAP / HIP-HOP',file:'智声说唱预设.trackpreset',preview:'/assets/preset-previews/zhisheng-rap-preview.mp3'},
  {id:'backing',name:'和声backing预设',description:'为和声与叠唱建立清晰、宽阔且可控的空间层次。',icon:'waves',tag:'BACKING VOCAL',file:'和声backing预设.trackpreset',preview:'/assets/preset-previews/harmony-backing-preview.mp3'},
  {id:'udg',name:'智声udg预设',description:'适合需要厚度与质感的人声起始处理，便于快速进入制作。',icon:'mic-vocal',tag:'ZHISHENG UDG',file:'智声udg预设.trackpreset',preview:'/assets/preset-previews/zhisheng-udg-preview.mp3'},
  {id:'pop',name:'智声流行预设',description:'保留人声细节，建立明亮、有空气感的流行表达。',icon:'sparkles',tag:'POP VOCAL',file:'智声流行预设.trackpreset',preview:'/assets/preset-previews/zhisheng-pop-preview.mp3'},
  {id:'retro',name:'智声复古预设',description:'加入温暖、柔和的复古色彩，适合怀旧与磁带感作品。',icon:'disc',tag:'RETRO COLOR',file:'智声复古预设.trackpreset',preview:'/assets/preset-previews/zhisheng-retro-preview.mp3'},
  {id:'electronic',name:'电音电子预设',description:'为电子人声与合成器声部建立更鲜明的动态和空间方向。',icon:'radio',tag:'ELECTRONIC',file:'电音电子预设.trackpreset',preview:'/assets/preset-previews/electronic-preview.mp3'}
];
function presetDetail(id){ const preset=presetLibrary.find(item=>item.id===id); if(!preset)return notFound(); return `<main class="shell page preset-detail-page"><section class="preset-detail-hero"><div><div class="eyebrow">EFFECT PRESET / ${preset.tag}</div><h1>${preset.name}</h1><p>${preset.description}</p><div class="preset-detail-actions"><a class="btn btn-primary" href="/assets/presets/${encodeURIComponent(preset.file)}" download>${icon('download')} 下载预设文件</a>${link('/presets','返回效果预设','btn btn-secondary')}</div></div><div class="preset-detail-art preset-photo-art">${presetPhoto(preset.id)}</div></section><section class="preset-detail-grid"><article class="preset-audio-panel"><div class="eyebrow">AUDIO PREVIEW</div><h2>试听音频</h2><p class="audio-ready-copy">点击播放，试听此预设对应的声音效果。</p><audio class="preset-audio-player" controls preload="metadata" src="${preset.preview}">你的浏览器暂不支持音频播放。</audio></article><aside class="preset-file-panel"><div class="eyebrow">PRESET FILE</div><h2>文件信息</h2><dl><div><dt>文件名</dt><dd>${preset.file}</dd></div><div><dt>类型</dt><dd>Studio One Track Preset</dd></div><div><dt>用途</dt><dd>${preset.tag}</dd></div></dl></aside></section></main>`; }
function presetsPage(){ return `<main class="shell page"><section class="page-title"><div class="eyebrow">EFFECT PRESETS / STARTING POINTS</div><h1>效果预设</h1><p>选择一个声音方向，查看对应预设文件并预留试听入口。每个预设都可以作为 Studio One 制作的起点。</p></section><section class="preset-grid">${presetLibrary.map(p=>`<a class="preset-card preset-card-link" href="/presets/${p.id}" data-route>${presetPhoto(p.id)}<span class="service-icon">${icon(p.icon)}</span><span class="preset-tag">${p.tag}</span><h3>${p.name}</h3><p>${p.description}</p><span class="text-link">查看预设与试听 ${icon('arrow-up-right')}</span></a>`).join('')}</section><section class="feature-band"><div><div class="eyebrow">AI PRESET GUIDE</div><h2>不知道从哪个预设开始？</h2><p>描述你的曲风、参考作品、设备和想要的声音感受，AI 智能体会帮你推荐合适的起点。</p></div>${link('/ai-agent',`咨询 AI 智能体 ${icon('sparkles')}`,'btn btn-primary')}</section></main>`; }
...
function bindEvents() {
  ...
  document.querySelectorAll('.filter').forEach(button => button.addEventListener('click', () => {
    ...
    if (!selected) return;
    document.querySelectorAll('.people-grid .person-card').forEach(card => {
      card.hidden = selected !== '全部' && !card.dataset.genres.split(' ').includes(selected);
    });
  }));
...
try { app(); } catch (error) { document.querySelector('#app').textContent = `JS ERROR: ${error.stack || error.message}`; }
enhanceHome();
